...
public class config
{
    public static int[] gradientArr = {R.drawable.gc1,R.drawable.gc2,R.drawable.gc3,R.drawable.gc4,
            R.drawable.gc5,R.drawable.gc6, R.drawable.gc7,R.drawable.gc8,R.drawable.gc9,R.drawable.gc10,
